...
public class DirectIndex {
	...
	private static void processDocument(String fileName) throws IOException
    {
        HashMap<String, Integer> wordList = new HashMap<String, Integer>();

        HashMap<String, Double> tfList = new HashMap<String, Double>(); // pentru stocarea tf-ului
        ...
        {
            if (!Character.isLetterOrDigit((char)currentChar)) // suntem pe un separator
            {
                ...
                if (exceptions.contains(newWord))
                {
                ...
                else if (stopwords.contains(newWord))
                {
                    sb.setLength(0);
                    continue;
                }
        ...
        //inserare in db
        MongoDatabaseClient.insertInDirectIndex(fileName,wordList);
        ...
        MongoDatabaseClient.insertInTF(fileName,tfList);
    }
	
	public static void createDirectIndex(WebsiteInfo websiteInfo) throws IOException
	{
        ...
        System.out.println(websiteFolder.toString());
        
        //goleste colectiile direct index si tf din mongo
        MongoDatabaseClient.emptyCollectionDirectIndex();
        MongoDatabaseClient.emptyCollectionTF();
            ...
            try {
                	for (File file : listOfFiles)
                	{
                		...
                		if (file.isFile() && Files.probeContentType(file.toPath()).equals("text/html"))
                		{
                			...
                			String textFileName = textFile.getCanonicalPath();
                			
                			//System.out.println(textFileName);

                			processDocument(textFileName);
        ...
        System.out.println("indexDirect si TF inserate");
